...
// Output scaled gyro biases for tft in the main program
...
// Output scaled accelerometer biases for tft in the main program
...
void setup()
{
  ...
  {  
    ...
    tft.fillScreen(TFT_BLACK);
    tft.setCursor(20,0); tft.print("AK8963");
    tft.setCursor(0,10); tft.print("ASAX "); tft.setCursor(50,10); tft.print(magCalibration[0], 2);
    tft.setCursor(0,20); tft.print("ASAY "); tft.setCursor(50,20); tft.print(magCalibration[1], 2);
    tft.setCursor(0,30); tft.print("ASAZ "); tft.setCursor(50,30); tft.print(magCalibration[2], 2);
    delay(1000);  
  }
  else
  {
